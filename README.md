...
**Current release:** [2020.05.0](https://github.com/raiden-network/raiden-service-bundle/tree/2020.05.0)
...
1. Clone the [current release version of this repository](https://github.com/raiden-network/raiden-service-bundle/tree/2020.05.0)
   to a suitable location on the server:

   ```shell
   git clone -b 2020.05.0 https://github.com/raiden-network/raiden-service-bundle.git
   ```
