...
1. Clone the [current release version of this repository](https://github.com/raiden-network/raiden-service-bundle/tree/2021.05.0rc4)
   to a suitable location on the server:

   ```shell
   git clone -b 2021.05.0rc4 https://github.com/raiden-network/raiden-service-bundle.git
   ```
